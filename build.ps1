...
$items = @{
	...
	'freetype' = @{
		'ArchiveUrl' = 'http://dl.hexchat.net/gtk-win32/src/freetype-2.6.3.tar.bz2'
		'Dependencies' = @()
	};
	...
	'libpng' = @{
		'ArchiveUrl' = 'https://dl.hexchat.net/gtk-win32/src/libpng-1.6.22.tar.xz'
		'Dependencies' = @('zlib')
	};
	...
	'openssl' = @{
		'ArchiveUrl' = 'http://dl.hexchat.net/gtk-win32/src/openssl-1.0.2g.tar.gz'
		'Dependencies' = @()
	};
