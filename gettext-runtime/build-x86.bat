...
cmake -G "NMake Makefiles" -DCMAKE_INSTALL_PREFIX=%GETTEXT_DEST% -DCMAKE_BUILD_TYPE=Release -DICONV_INCLUDE_DIR=%GETTEXT_SRC%\..\..\..\gtk\Win32\include -DICONV_LIBRARIES=%GETTEXT_SRC%\..\..\..\gtk\Win32\lib\iconv.lib -Od
nmake clean
nmake
